package com.aslam.junaid.ad340.details
...
import com.aslam.junaid.ad340.databinding.FragmentForecastDetailsBinding
...
class ForecastDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewStateObserver = Observer<ForecastDetailsViewState> { viewState ->
            // update the UI
            binding.tempText.text = formatTempForDisplay(viewState.temp,
